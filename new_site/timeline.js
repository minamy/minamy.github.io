...
function draw(){
	...
	var fsize = parseInt(bounds.y/4);
	c.font = fsize+"px Tahoma";
	var date = (new Date((start-60)*60000)).toDateString().substr(4, 100);
	var time = (new Date((start-60)*60000)).toTimeString().substr(0, 5);
	//c.save();
	...
	c.restore();
	date = (new Date((start+width-60)*60000)).toDateString().substr(4, 100);
	time = (new Date((start+width-60)*60000)).toTimeString().substr(0, 5);
	//c.save();
